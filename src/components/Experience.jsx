	...
	return (
		<VerticalTimelineElement
			...
			iconStyle={{
				...
				cursor: experience.url ? 'pointer' : 'default',
			}}
		...
		>
			<motion.div
				whileHover={experience.url ? { scale: 1.05 } : {}}
				transition={
					experience.url
				...
				onClick={handleClick}
				className={`bg-[#1d1836] p-5 rounded-[20px] ${experience.url ? 'cursor-pointer hover hover:border-[#915EFF] transition-colors duration-300' : ''} shadow-card border-b-4 border-transparent `}
			>
				<div>
				...
				>
					<div className='bg-tertiary rounded-[20px] py-5 px-5 h-full flex flex-col justify-start'>
						...
						<div className='flex flex-col items-center'>
							...
							<p className='text-white-100 xs:text-[21px] xxs:text-[19px] text-[17px] text-center font-medium'>
								{Position}
							</p>
						</div>
