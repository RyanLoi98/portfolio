...
const Navbar = () => {
    ...
    return (
        <nav className={`${styles.paddingX} w-full flex items-center py-5 top-10 z-50 bg-primary`}>            
            ...
            <div className = "w-full flex justify-between items-center max-w-7xl mx-auto">
                ...
                <div className = "sm:hidden flex flex-1 justify-end items-center">
                    ...
                    <div className = {`${!isMobile ? "hidden" : "flex"} p-6 black-gradient absolute top-12 right-0 mx-4 my-2 min-w-[115px] z-10 rounded-xl`}>
