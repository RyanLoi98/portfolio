  ...
  return (
    <>
      ...
      <motion.p
        ...
        viewport={{ once: true, amount: 0.2 }}
      >
        I’m a Computer Science and Cellular Molecular and Microbial Biology
        graduate from the University of Calgary, where I earned my dual degrees
        <strong>
          <em> with Distinction</em>
        </strong>
        . This background fuels my passion for solving complex problems and
        developing user-centric software that is both innovative and reliable. I
        specialize in building clean, scalable, and accessible applications,
        relying on the robust terminal environment and flexibility of Ubuntu to
