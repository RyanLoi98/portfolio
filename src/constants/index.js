...
const experiences = [
	{
		title: 'Software Engineer - Web Engineering Team',
		company_name: 'Canonical (Remote)',
		...
		duration: 'Present',
		points: [
			`I am a Software Engineer at Canonical, working within the Web Engineering team 
      to build: scalable, reliable, accessible, and high-performance web applications for a global audience. 
      I collaborate closely with a distributed, remote-first team to ensure our digital products meet the rigorous 
